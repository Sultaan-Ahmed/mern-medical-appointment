...
const ServiceCard = ({item,index}) => {
  ...
  return (
    <div className="py-[30px] px-3 lg:px-5">
        <h2 className="text-headingColor leading-9 text-[26px] font-[700] text-center">{name}</h2>
        <p className="leading-7 text-[16px] font-[400] text-textColor text-justify mt-4">{desc}</p>
