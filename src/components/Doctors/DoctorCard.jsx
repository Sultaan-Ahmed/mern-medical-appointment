    ...
    <>
        <div className="p-3 lg:p-5">
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6  text-[12px] rounded leading-4 lg:text-[16px] lg:leading-7 font-semibold">{specialty}</span>
                <div className='flex items-center gap-[6px]'>
                    ...
                    <span className='text-textColor font-[400] text-[14px] leading-6 lg:text-[16px] lg:leading-7'>{totalRating}</span>
                </div>
            </div>
            <div className='flex items-center justify-between mt-[18px] lg:mt-5'>
                <div>
                    ...
                    <p className='text-[14px] leading-6 text-textColor font-[400]'>At {hospital}</p>
                </div>
